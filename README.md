...
ctest --test-dir build          # 跑單元測試（共 9 條）
...
*55 張 PCE-CD（PC Engine CD-ROM²，1988 NEC HuCard 主機的 1991 CD 增訂版）怪物立繪
（從 [wizardry.wiki.gg](https://wizardry.wiki.gg) 取得，CC-BY-SA 4.0 — Creative Commons 創用 CC「姓名標示-相同方式分享 4.0 國際」授權）。
包含 Werdna 沃登納、Vampire Lord 吸血鬼領主、Vorpal Bunny 致命兔、Greater Demon 大惡魔，
以及各等級的 Fighter / Mage / Priest / Thief / Ninja（戰士 / 魔法師 / 牧師 / 盜賊 / 忍者）。
執行 `tools/fetch_pcecd_sprites.sh` 取得。*
